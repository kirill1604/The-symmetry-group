...
Для [генерации](./configs/REINVENT4_sampling_config.toml) был выбран режим `Mol2Mol`, для которого были отобраны [топ 57 ингибиторов](./data/REINVENT4_mol2mol_hdac6_active.smi) `HDAC6`, отсортированных по `pIC50`:
...
<!-- TODO: Удалить, если неактуально -->

Также произведена фильтрация и отбор через скоринг REINVENT4
